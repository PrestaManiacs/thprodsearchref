...
<div class="panel">
    <h3><i class="icon icon-star"></i> {l s='Presta Maniacs' mod='thdev'}</h3>
    <img src="{$module_dir|escape:'html':'UTF-8'}/logo.png" id="payment-logo" class="pull-right" width="75" />
    <p>
        {l s='If you have any question about our module, or if you need help with your PrestaShop store, please contact us!' mod='thdev'}
    </p>
